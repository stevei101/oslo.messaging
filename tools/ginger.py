...
def notifier(_id, transport, messages, wait_after_msg, timeout):
    ...
    for i in range(0, messages):
        ...
        payload = json.loads(
            '''{"payload": 
            {"image_id": "59fb31a1-a811-4319-aa32-337bce52506e",
            "owner_id": "bdb2c1967da749ddac4f71ca9462bf64",
            "receiver_tenant_id": "bdb2c1967da749ddac4f71ca9462bf64",
            "receiver_user_id": "",
        ...
        LOG.info("send msg")
        LOG.info(payload)
        n1.info(ctxt, 'image.update', payload)
        if wait_after_msg > 0:
            time.sleep(wait_after_msg)
